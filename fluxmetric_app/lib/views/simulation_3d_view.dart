...
class _Simulation3DViewState extends State<Simulation3DView> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        // Column 2: Current View
        Expanded(
          flex: 4,
          child: Column(
            children: [
              // Local TabBar for the Viewport only
              Container(
                ...
                child: TabBar(
                  ...
                  tabs: const [
                    Tab(text: '3D View', icon: Icon(Icons.view_in_ar, size: 20)),
                    Tab(text: '2D Technical Heatmap', icon: Icon(Icons.map, size: 20)),
                  ],
                ),
              ),
        ...
        // Column 3: Operation Panel (Sidebar)
        Container(
          width: 350,
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Simulation Workspace', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                    const Text('Configure scene and calculations', style: TextStyle(fontSize: 12, color: Colors.grey)),
                  ],
                ),
              ),
              const Divider(height: 1),
